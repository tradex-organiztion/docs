...
A. 현재 트레이덱스 팀은 더 많은 거래소를 지원하기 위해 활발한 업데이트를 진행하고 있어요. <Tooltip tip="트레이덱스 카카오톡 채널" cta="http://pf.kakao.com/_WxidEX/chat" href="http://pf.kakao.com/_WxidEX/chat">카카오톡 채널</Tooltip>로 사용하시는 거래소를 공유해주시면 최대한 빠르게 업데이트하고 연락드리겠습니다. 신청자가 많은 거래소 순서대로 지원할 예정이니 꼭 접수해주세요.